...
build:
	...
	gcc -g -Wall -Wno-unused-function -o cross_assembler.o asm_table.c cross_assembler.c
...
speed:
	...
	gcc -O3 -Wall -Wno-unused-function -o cross_assembler.o asm_table.c cross_assembler.c
